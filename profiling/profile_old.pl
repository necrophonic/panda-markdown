...
my $in = q(Yup, we're here! Caffeinated Panda Creations has launched the first )
	     ...
	     .q(and services, so here's some things to whet your appetite!@@[C2]||##1|Custom )
	     ...
	     .q(are the proud owners of a [[http://store.makerbot.com/replicator2.html|Makerbot Replicator 2]] 3D printer.\n\nAs well as using it for our creations we can also offer a bespoke printing service. Design your own objects or let us work with you to create and realise your vision in high quality PLA plastic.||@@ @@[C2]||##1|Emporia##{{etsy.jpg|<<,H100,W130}}Over the next few months we'll be opening our online stores where we'll be selling some of our premade and customisable pieces along with t-shirts and other apparel.|| ||##1|Costuming##{{mask.jpg|<<,H100,W130}}The panda team are keen costumers and going forward will be working on several exciting cosplaying projects for ourselves and others.\n\nWe'll also be keeping you up to date on where we'll be appearing and giving details on how we can work with you on your own costuming projects.||@@);

my $tokenizer = PML::Tokenizer2->new(pml => $in) for 1..100;
